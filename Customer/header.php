...
<head>
    <meta charset="UTF-8">
    <title>TrendCart - Customer Homepage</title>
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse justify-content-center ml-2" id="navbarNav">
            <ul class="navbar-nav mt-0">
                ...
                <li class="nav-item"><a class="nav-link text-light" href="product.php">PRODUCT</a></li>
                <li class="nav-item"><a class="nav-link text-light" href="about.php">ABOUT US</a></li>
                <li class="nav-item"><a class="nav-link text-light" href="feedback.php">FEEDBACK</a></li>
                <li class="nav-item"><a class="nav-link text-light" href="contact.php">CONTACT US</a></li>
            </ul>
            <div class="ml-auto d-flex align-items-center">
                <div class="cart-box ml-3">
                    <a href="cart.php"><i class='bx bx-cart text-light' style="font-size: 1.5em;"></i></a>
                </div>
