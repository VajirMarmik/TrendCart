...
$pdf->SetAuthor('Admin');
$pdf->SetTitle('TrendCart - '. $vendorUsername ."'s Verified Products Report");
...
$sql = "SELECT p.*, c.name AS category_name, b.name AS brand_name, v.username AS vendor_name
        ...
        WHERE p.vendor_id = $vendorId AND p.status = 'verified'";
...
$pdf->Output('TrendCart - '. $vendorUsername ."'s Verified Products Report.pdf", 'D');
?>
