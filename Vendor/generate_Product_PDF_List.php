...
if ($result->num_rows > 0) {
    ...
    while ($row = $result->fetch_assoc()) {
        ...
        $html .= '<tr>
                    ...
                    <td width="7%">' . $row['vendor_name'] . '</td>
                    <td width="8%">' . $row['category_name'] . '</td>
                    <td width="7%">' . $row['brand_name'] . '</td>
                    <td width="8%"><img src="' . $imgSrc . '" alt="' . $imgAlt . '" width="100" height="auto"></td>
                    <td width="8%">' . $row['product_name'] . '</td>
                    <td width="5%">' . $row['size'] . '</td>
                    <td width="6%">' . $row['color'] . '</td>
                    <td width="7%">' . $row['type'] . '</td>
                    <td width="16%">' . $row['description'] . '</td>
                    <td width="7%">' . $row['price'] . '</td>
                    <td width="10%">' . $row['created_at'] . '</td>
                    <td width="7%">' . ucfirst(str_replace('_', ' ', $row['status'])) . '</td>
                  </tr>';
    }
