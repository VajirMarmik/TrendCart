...
$pdf->SetAuthor('Admin');
$pdf->SetTitle('TrendCart - ' . $vendorUsername . "'s Not Verified Products Report"); // Corrected line
...
$sql = "SELECT p.*, c.name AS category_name, b.name AS brand_name, v.username AS vendor_name
        ...
        WHERE p.vendor_id = $vendorId AND p.status = 'not_verified'";
...
$pdf->Output('TrendCart - ' . $vendorUsername . "'s Not Verified Products Report.pdf", 'D');
?>
