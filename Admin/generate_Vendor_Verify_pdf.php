...
$pdf->SetAuthor('Admin');
$pdf->SetTitle('TrendCart - Verified Vendors Report');
...
if ($startDate && $endDate) {
    $title = 'Verified Vendors Report - Of ' . htmlspecialchars($startDate) . ' To ' . htmlspecialchars($endDate);
} else {
    $title = 'Verified Vendors Report - All Verified Vendors';
}
...
$pdf->Output('TrendCart - Verified Vendors Report.pdf', 'D');
?>
