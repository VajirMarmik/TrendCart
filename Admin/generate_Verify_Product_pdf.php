...
$pdf->SetAuthor('Admin');
$pdf->SetTitle('TrendCart - Verified Products Report');
...
if ($result === FALSE) {
    ...
    if ($startDate && $endDate) {
        $title = 'Verified Products Report - Of ' . htmlspecialchars($startDate) . ' To ' . htmlspecialchars($endDate);
    } else {
        $title = 'Verified Products Report - All Verified Products';
    }
...
$pdf->Output('TrendCart - Verified Products Report.pdf', 'D');
?>
