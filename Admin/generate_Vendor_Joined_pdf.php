...
$pdf->SetAuthor('Admin');
$pdf->SetTitle('TrendCart - Joined Vendors Report');
...
if ($startDate && $endDate) {
    $title = 'Joined Vendors Report - Of ' . htmlspecialchars($startDate) . ' To ' . htmlspecialchars($endDate);
} else {
    $title = 'Joined Vendors Report - All Joined Vendors';
}
...
$pdf->Output('TrendCart - Joined Vendors Report.pdf', 'D');
?>
