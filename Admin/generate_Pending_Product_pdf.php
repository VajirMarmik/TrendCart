...
$pdf->SetAuthor('Admin');
$pdf->SetTitle('TrendCart - Pending Products Report');
...
if ($result === FALSE) {
    ...
    if ($startDate && $endDate) {
        $title = 'Pending Products Report - Of ' . htmlspecialchars($startDate) . ' To ' . htmlspecialchars($endDate);
    } else {
        $title = 'Pending Products Report - All Pending Products';
    }
...
$pdf->Output('TrendCart - Pending Products Report.pdf', 'D');
?>
