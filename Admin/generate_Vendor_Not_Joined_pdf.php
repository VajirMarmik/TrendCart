...
$pdf->SetAuthor('Admin');
$pdf->SetTitle('TrendCart - Not Joined Vendors Report');
...
$sql .= " ORDER BY created_at DESC";  // Sort the results in descending order
...
if ($startDate && $endDate) {
    $title = 'Not Joined Vendors Report - Of ' . htmlspecialchars($startDate) . ' To ' . htmlspecialchars($endDate);
} else {
    $title = 'Not Joined Vendors Report - All Not Joined Vendors';
}
...
$pdf->Output('TrendCart - Not Joined Vendors Report.pdf', 'D');
?>
