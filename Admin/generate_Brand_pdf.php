...
$pdf->SetAuthor('Admin');
$pdf->SetTitle('TrendCart - Brands Report');
...
// Fetch brands based on selected date range
...
if ($result === FALSE) {
    ...
    if ($startDate && $endDate) {
        $title = 'Brands Report - Of ' . htmlspecialchars($startDate) . ' To ' . htmlspecialchars($endDate);
    } else {
        $title = 'Brands Report - All Brands';
    }
...
$pdf->Output('TrendCart - Brands Report.pdf', 'D');
?>
